    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.verContrato = async function(id) {
            try {
                ...
                document.getElementById('contratoDetalleContent').innerHTML = `
        ...
        window.verPlano = async function(id) {
            try {
                ...
                document.getElementById('planoDetalleContent').innerHTML = `
        ...
        document.getElementById('btnCerrarModalSubir')?.addEventListener('click', function() {
        ...
        document.getElementById('btnSubirArchivo')?.addEventListener('click', async function() {
            ...
            const version = document.getElementById('modalVersionDoc').value;
            const file = fileInput.files[0];

            if (!tipo || !proyectoId || !numero || !nombre || !file) {
            ...
            formData.append('no_documento', numero);
