            ...
            <div class="card-body p-4">
                ...
                <div style="display: flex; justify-content: flex-end; margin-top: 10px;">
                    <div style="background-color: #f0f4ff; padding: 5px 15px; border-radius: 20px; border-left: 3px solid #083CAE;">
                        <span style="font-size: 12px; color: #083CAE; font-weight: 600;" id="nivelActual">Nivel 1 / 5</span>
                    </div>
                </div>
    ...
    (function() {
        ...
        if (mesSelector) {
            mesSelector.addEventListener('change', function(e) {
                e.preventDefault();
                EstadoApp.expandedCuentas.clear();
                EstadoApp.nivelExpandido = 0;
                document.getElementById('nivelActual').textContent = 'Nivel 0 / 5';
                cargarTabla();
            });
        }
