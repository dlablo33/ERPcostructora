                    ...
                    <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                        ...
                        <div>
                            <button id="btnAgregar" 
                                    ...
                                    onclick="alert('Agregar incidencia - En desarrollo')">
                    ...
                    <table class="table" id="tablaIncidencias" style="width: 100%; border-collapse: collapse; font-size: 12px; min-width: 800px;">
                        <thead style="background-color: var(--color-primary);">
                            <tr>
                                ...
                                <th style="padding: 12px 8px; border: 1px solid #dee2e6; background-color: var(--color-primary); color: white; text-align: center; width: 10%;">Estatus</th>
                                <th style="padding: 12px 8px; border: 1px solid #dee2e6; background-color: var(--color-primary); color: white; text-align: center; width: 15%;">Empleado</th>
                                <th style="padding: 12px 8px; border: 1px solid #dee2e6; background-color: var(--color-primary); color: white; text-align: center; width: 20%;">Tipo Incidencia</th>
                                <th style="padding: 12px 8px; border: 1px solid #dee2e6; background-color: var(--color-primary); color: white; text-align: center; width: 30%;">Descripción</th>
                                <th style="padding: 12px 8px; border: 1px solid #dee2e6; background-color: var(--color-primary); color: white; text-align: center; width: 12%;">Fecha</th>
                                <th style="padding: 12px 8px; border: 1px solid #dee2e6; background-color: var(--color-primary); color: white; text-align: center; position: sticky; right: 0; z-index: 35; box-shadow: -2px 0 5px rgba(0,0,0,0.1); width: 8%;">Acciones</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">2</td>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">JOSE MANUEL</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">Atraso con Cliente</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: left;">pruebas</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">2025-10-16</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; position: sticky; right: 0; background-color: white; box-shadow: -2px 0 5px rgba(0,0,0,0.1); text-align: center;">
                                    ...
                                    <i class="fas fa-edit" style="color: var(--color-primary); margin: 0 5px; cursor: pointer;" onclick="alert('Editar incidencia')"></i>
                                    <i class="fas fa-trash" style="color: #dc3545; margin: 0 5px; cursor: pointer;" onclick="if(confirm('¿Eliminar incidencia?')) alert('Incidencia eliminada')"></i>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">LUIS</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">Golpe a Unidad</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: left;">Chocó con barda de cliente (Descarga MTY)</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">2025-01-15</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; position: sticky; right: 0; background-color: white; box-shadow: -2px 0 5px rgba(0,0,0,0.1); text-align: center;">
                                    <i class="fas fa-eye" style="color: var(--color-primary); margin: 0 5px; cursor: pointer;" onclick="alert('Ver detalle')"></i>
                                    <i class="fas fa-edit" style="color: var(--color-primary); margin: 0 5px; cursor: pointer;" onclick="alert('Editar incidencia')"></i>
                                    <i class="fas fa-trash" style="color: #dc3545; margin: 0 5px; cursor: pointer;" onclick="if(confirm('¿Eliminar incidencia?')) alert('Incidencia eliminada')"></i>
                        ...
                        <tfoot style="background-color: #f8f9fa;">
                            <tr>
                                <td colspan="7" style="padding: 10px; border: 1px solid #dee2e6; text-align: center; font-weight: bold; font-size: 13px;">Cantidad: 2</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.toggleColumnSelector = function() {
        ...
        if (selector.style.display === 'block') {
            const columnas = [
                ...
                { field: 'tipo', caption: 'Tipo Incidencia' },
    ...
    document.getElementById('btnAgregar').addEventListener('click', () => alert('Agregar incidencia - En desarrollo'));
