    ...
    <section class="content container-fluid py-3">
        ...
        <div class="semaforo card mt-2">
            ...
            <div class="card-body p-4">
                ...
                <!-- Tabla de Registro de Vacaciones -->
                    ...
                    <table class="table" id="tablaVacaciones" style="width: 100%; border-collapse: collapse; font-size: 12px; min-width: 800px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">22/03/2025</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center; font-weight: bold;">7</td>
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center; font-weight: bold;">6</td>
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">15/03/2025</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center; font-weight: bold;">10</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; position: sticky; right: 0; background-color: white; box-shadow: -2px 0 5px rgba(0,0,0,0.1); text-align: center;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">05/03/2025</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center; font-weight: bold;">4</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; position: sticky; right: 0; background-color: #f8f9fa; box-shadow: -2px 0 5px rgba(0,0,0,0.1); text-align: center;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center; font-weight: bold;">8</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; position: sticky; right: 0; background-color: white; box-shadow: -2px 0 5px rgba(0,0,0,0.1); text-align: center;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">14/02/2025</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center; font-weight: bold;">4</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; position: sticky; right: 0; background-color: white; box-shadow: -2px 0 5px rgba(0,0,0,0.1); text-align: center;">
                                    ...
                                    <i class="fas fa-trash" style="color: #dc3545; margin: 0 5px; cursor: pointer;" onclick="if(confirm('¿Eliminar registro?')) alert('Registro eliminado')"></i>
                                    <i class="fas fa-file-pdf" style="color: #dc3545; margin: 0 5px; cursor: pointer;" onclick="alert('Generar PDF folio 1007')"></i>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">05/02/2025</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center;">12/02/2025</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; text-align: center; font-weight: bold;">7</td>
                                <td style="padding: 10px 8px; border: 1px solid #dee2e6; position: sticky; right: 0; background-color: #f8f9fa; box-shadow: -2px 0 5px rgba(0,0,0,0.1); text-align: center;">
                                    ...
                                    <i class="fas fa-trash" style="color: #dc3545; margin: 0 5px; cursor: pointer;" onclick="if(confirm('¿Eliminar registro?')) alert('Registro eliminado')"></i>
                                    <i class="fas fa-file-pdf" style="color: #dc3545; margin: 0 5px; cursor: pointer;" onclick="alert('Generar PDF folio 1008')"></i>
                                </td>
                            </tr>
                        </tbody>
                        <tfoot style="background-color: #e9ecef; font-weight: bold;">
                            <tr>
                                <td colspan="5" style="padding: 12px 8px; border: 1px solid #dee2e6; text-align: right;">Total Registros:</td>
                            ...
                            <tr>
                                <td colspan="6" style="padding: 10px; border: 1px solid #dee2e6; text-align: center; background-color: #f8f9fa;">Total Vacaciones Registradas: 8</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<!-- MODAL PARA NUEVO REGISTRO DE VACACIONES -->
<div id="modalVacaciones" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); z-index: 100000; align-items: center; justify-content: center;">
    <div style="background-color: white; border-radius: 8px; width: 95%; max-width: 600px; max-height: 90vh; overflow-y: auto; position: relative; animation: slideIn 0.3s ease;">
        ...
        <div style="background: var(--color-primary); padding: 15px 20px; border-radius: 8px 8px 0 0; display: flex; justify-content: space-between; align-items: center;">
            <h3 style="color: white; margin: 0; font-size: 18px;">Nuevo Registro de Vacaciones</h3>
        ...
        <div style="padding: 20px;">
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px;">
                ...
                <div>
                    ...
                    <input type="number" style="width: 100%; padding: 8px; border: 1px solid #ced4da; border-radius: 4px;" placeholder="7">
                </div>
            </div>
            
            <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px;">
                <button onclick="cerrarModalVacaciones()" style="padding: 8px 20px; border: 1px solid #ced4da; border-radius: 4px; background: white; cursor: pointer;">Cancelar</button>
                <button onclick="alert('Registro de vacaciones guardado')" style="padding: 8px 20px; border: none; border-radius: 4px; background: var(--color-primary); color: white; cursor: pointer;">Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        #modalVacaciones div[style*="grid-template-columns: repeat(2, 1fr)"] {
...
document.getElementById('modalVacaciones').addEventListener('click', function(e) {
    if (e.target === this) {
        cerrarModalVacaciones();
    }
});
