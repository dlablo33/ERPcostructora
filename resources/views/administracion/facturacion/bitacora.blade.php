            ...
            <div class="card-body p-4">
                ...
                <div class="table-responsive" style="margin-top: 20px; border: 1px solid #dee2e6; border-radius: 8px; max-height: 600px; overflow-y: auto; position: relative;" id="tablaContainer">
                    <table class="table table-bordered" id="tablaBitacora" style="width: 100%; margin-bottom: 0; font-size: 12px; border-collapse: collapse;">
                        ...
                        <!-- Fila de totales (summary vacío según el código) -->
                        <tfoot id="tablaFoot" style="position: sticky; bottom: 0; z-index: 20; background-color: #e9ecef; font-weight: bold; display: none;">
                            <tr>
                                <td style="border: 1px solid #dee2e6; padding: 10px 4px; background-color: #e9ecef;" colspan="10"></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        function cargarTabla(datos) {
            ...
            datos.forEach(item => {
                ...
                row.innerHTML = `
                    ...
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.bitacora_id || '-'}</td>
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.contacto || '-'}</td>
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.unidad || '-'}</td>
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.descripcion || '-'}</td>
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px; text-align: right;">${item.tot_facturas !== undefined ? formatCurrency(item.tot_facturas) : '-'}</td>
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.contra_recibo_id || '-'}</td>
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.empresa || '-'}</td>
