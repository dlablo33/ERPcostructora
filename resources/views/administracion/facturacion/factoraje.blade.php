                ...
                <div class="table-responsive" style="margin-top: 20px; border: 1px solid #dee2e6; border-radius: 8px; max-height: 600px; overflow-y: auto; position: relative;" id="tablaContainer">
                    <table class="table table-bordered" id="tablaFactoraje" style="width: 100%; margin-bottom: 0; font-size: 12px; border-collapse: collapse;">
                        ...
                        <tfoot id="tablaFoot" style="position: sticky; bottom: 0; z-index: 20; background-color: #e9ecef; font-weight: bold;">
                            <tr>
                                <td style="border: 1px solid #dee2e6; padding: 10px 4px; text-align: center; background-color: #e9ecef;" colspan="1">Total:</td>
                                <td style="border: 1px solid #dee2e6; padding: 10px 4px; text-align: center; background-color: #e9ecef;" id="totalRegistros">0 registros</td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const datosFactoraje = [
            {
                factoraje_id: 'FAC-001',
                estatus: 'Activo',
                contacto: 'Maquiladora Industrial',
                contacto_proveedor: 'Transportes del Bajío'
            },
            {
                factoraje_id: 'FAC-002',
                estatus: 'Proceso',
                contacto: 'Cartones del Norte',
                contacto_proveedor: 'Logística Monterrey'
            },
            {
                factoraje_id: 'FAC-003',
                estatus: 'Completado',
                contacto: 'Comercializadora del Sur',
                contacto_proveedor: 'Autotransportes Mexicanos'
            },
            {
                factoraje_id: 'FAC-004',
                estatus: 'Pendiente',
                contacto: 'Papelera del Pacífico',
                contacto_proveedor: 'Ferrocarriles Nacionales'
            },
            {
                factoraje_id: 'FAC-005',
                estatus: 'Cancelado',
                contacto: 'Minería del Norte',
                contacto_proveedor: 'Cervecería del Centro'
            },
            {
                factoraje_id: 'FAC-006',
                estatus: 'Activo',
                contacto: 'Distribuidora de Papel',
                contacto_proveedor: 'Transportes Unidos'
            }
        ];
        ...
        function cargarTabla(datos) {
            ...
            datos.forEach(item => {
                ...
                if (item.estatus === 'Inactivo') badgeClass = 'badge-inactivo';
                else if (item.estatus === 'Pendiente') badgeClass = 'badge-pendiente';
                ...
                row.innerHTML = `
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.factoraje_id || '-'}</td>
                    ...
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.contacto_proveedor || '-'}</td>
        ...
        document.getElementById('buscador')?.addEventListener('input', function(e) {
            ...
            const datosFiltrados = datosFactoraje.filter(item => 
                item.factoraje_id?.toLowerCase().includes(busqueda) ||
                item.contacto?.toLowerCase().includes(busqueda) ||
                item.contacto_proveedor?.toLowerCase().includes(busqueda) ||
