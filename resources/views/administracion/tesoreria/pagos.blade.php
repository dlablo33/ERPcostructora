                ...
                <div class="table-responsive" style="margin-top: 20px; border: 1px solid #dee2e6; border-radius: 8px; max-height: 600px; overflow-y: auto; position: relative;" id="tablaContainer">
                    <table class="table table-bordered" id="tablaPagos" style="width: 100%; margin-bottom: 0; font-size: 12px; border-collapse: collapse;">
                        ...
                        <tfoot id="tablaFoot" style="position: sticky; bottom: 0; z-index: 20; background-color: #e9ecef; font-weight: bold;">
                            <tr>
                                <td style="border: 1px solid #dee2e6; padding: 10px 4px; text-align: left; background-color: #e9ecef;" colspan="3">Registros: <span id="totalRegistros">0</span></td>
                                <td style="border: 1px solid #dee2e6; padding: 10px 4px; text-align: center; background-color: #e9ecef;" colspan="3"></td>
                                <td style="border: 1px solid #dee2e6; padding: 10px 4px; text-align: center; background-color: #e9ecef;" colspan="3"></td>
                            </tr>
                        </tfoot>
                    </table>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const datosPagos = [
            ...
            {
                estatus_txt: 'Activo',
                pago_layout_id: 'PAG-002',
                cuenta_bancaria: '9876-5432-1098-7654',
                fecha: '2026-01-14',
                monto: 75000.00,
                moneda: 'MXN',
                tipo_cambio: 1.00,
                descripcion: 'Pago de factura FAC-002'
            },
            {
                estatus_txt: 'Pendiente',
                pago_layout_id: 'PAG-003',
                cuenta_bancaria: '5678-1234-5678-1234',
                fecha: '2026-01-13',
                monto: 32000.00,
                moneda: 'MXN',
                tipo_cambio: 1.00,
                descripcion: 'Pago de factura FAC-003'
            },
            {
                estatus_txt: 'Completado',
                pago_layout_id: 'PAG-004',
                cuenta_bancaria: '4321-8765-4321-8765',
                fecha: '2026-01-12',
                monto: 68000.00,
                moneda: 'MXN',
                tipo_cambio: 1.00,
                descripcion: 'Pago de factura FAC-004'
            },
            {
                estatus_txt: 'Cancelado',
                pago_layout_id: 'PAG-005',
        ...
        function cargarTabla(datos) {
            ...
            datos.forEach(item => {
                ...
                row.innerHTML = `
                    ...
                    <td style="border: 1px solid #dee2e6; padding: 10px 4px;">${item.pago_layout_id || '-'}</td>
        ...
        document.getElementById('buscador')?.addEventListener('input', function(e) {
            ...
            const datosFiltrados = datosPagos.filter(item => 
                item.pago_layout_id?.toLowerCase().includes(busqueda) ||
                item.cuenta_bancaria?.toLowerCase().includes(busqueda) ||
                item.descripcion?.toLowerCase().includes(busqueda) ||
                item.estatus_txt?.toLowerCase().includes(busqueda) ||
                item.moneda?.toLowerCase().includes(busqueda)
            );
        ...
        document.addEventListener('click', function(e) {
            if (e.target.classList.contains('fa-edit')) {
                alert('Editar Pago - Funcionalidad en desarrollo');
            } else if (e.target.classList.contains('fa-trash-alt')) {
                if (confirm('¿Está seguro de eliminar este pago?')) {
                    alert('Eliminar Pago - Funcionalidad en desarrollo');
                }
            } else if (e.target.classList.contains('fa-eye')) {
                alert('Ver detalles de Pago - Funcionalidad en desarrollo');
